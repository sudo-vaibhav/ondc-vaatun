    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <Badge variant="secondary" className="mb-4 border-2 border-foreground px-4 py-1">
          ...
          <p className="mb-4 text-xl text-muted-foreground md:text-2xl">
            ...
            . Handle subscription verification, domain ownership, and cryptographic operations with ease.
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Button size="lg" className="border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px]">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            ...
            is a Government of India initiative to democratize e-commerce by creating an open,
            interoperable network. It enables buyers and sellers to transact regardless of the
            platform they use, breaking down digital commerce silos.
          </p>
        </div>
      </section>
      ...
      <section id="api-endpoints" className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-12 text-center text-4xl font-bold">API Endpoints</h2>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <CardHeader>
                <div className="flex items-center gap-3">
                  <Badge className="border-2 border-foreground font-mono">POST</Badge>
                  <code className="text-lg font-semibold">/api/ondc/on_subscribe</code>
                </div>
                <CardTitle className="mt-4">ONDC Subscription Endpoint</CardTitle>
                <CardDescription>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ol className="list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
                      <li>ONDC sends an encrypted challenge using AES-256-ECB</li>
                      <li>The endpoint decrypts it using the Diffie-Hellman shared secret</li>
                      <li>Returns the decrypted answer to verify successful subscription</li>
                    </ol>
                  </div>
                  <div>
            ...
            <Card className="border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <CardHeader>
                <div className="flex items-center gap-3">
                  <Badge variant="secondary" className="border-2 border-foreground font-mono">GET</Badge>
                  <code className="text-lg font-semibold">/ondc-site-verification.html</code>
                </div>
  ...
  <body>ONDC Site Verification Page</body>
            ...
            <Card className="border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <CardHeader>
                <div className="flex items-center gap-3">
                  <Badge variant="secondary" className="border-2 border-foreground font-mono">GET</Badge>
                  <code className="text-lg font-semibold">/api/ondc/health</code>
                </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <div className="flex items-center justify-center gap-3 text-3xl md:text-5xl font-bold">
            <span>made with</span>
            <Badge variant="default" className="border-2 border-foreground px-6 py-3 text-2xl md:text-4xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <RotatingText
                texts={[
                  "Next.js 16",
                  "React 19",
      ...
      <footer className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-center text-sm text-muted-foreground sm:flex-row sm:text-left">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://nextjs.org/docs" target="_blank" rel="noopener noreferrer" className="hover:text-foreground">
              Next.js Docs
            </a>
            <a href="https://github.com/ONDC-Official/developer-docs" target="_blank" rel="noopener noreferrer" className="hover:text-foreground">
              Developer Guide
            </a>
          </div>
        </div>
