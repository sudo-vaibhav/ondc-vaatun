...
import type { Quote, SelectProvider, SelectItem } from "@/lib/selectStore";
                        ...
                        <CardContent className="py-12 text-center">
                            {isPolling ? (
                                <>
                                    ...
                                    <p className="text-lg font-medium mb-2">Getting your quote...</p>
                                            ...
                                            {item.tags[0]?.list?.slice(0, 6).map((tag) => (
                                                <div key={tag.descriptor?.code} className="text-sm">
                                                    <span className="text-muted-foreground block text-xs">
                                                        {tag.descriptor?.name || tag.descriptor?.code?.replace(/_/g, ' ')}
                                                    </span>
