...
export default function ProviderCard({ response }: ProviderCardProps) {
    ...
    const totalItems = providers.reduce((sum, p) => sum + (p.items?.length || 0), 0);
                ...
                <div className="flex items-center gap-3">
                    ...
                    {bppLogo ? (
                        <img
                            src={bppLogo}
                            alt={bppName}
                            className="h-10 w-10 rounded border-2 border-foreground object-contain bg-white"
                        />
                    ) : (
                    ...
                    <Badge variant="secondary" className="border-2 border-foreground flex items-center gap-1">
