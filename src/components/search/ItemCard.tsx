...
function formatTagValue(code: string, value: string): string {
    if (code === 'COVERAGE_AMOUNT' || code === 'ROOM_RENT_CAP' || code === 'PERSONAL_ACCIDENT_COVER') {
        ...
        <Card className="border-2 border-foreground shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all">
            <CardHeader className="pb-2">
                <div className="flex items-start justify-between gap-2">
                    ...
                    {tenure && (
                        <Badge variant="secondary" className="border border-foreground flex items-center gap-1 shrink-0">
            ...
            <CardContent className="pt-0">
                ...
                {addOnsCount > 0 && (
                    <div className="flex items-center gap-1 text-xs text-muted-foreground mb-3">
                        ...
                        <span>{addOnsCount} add-on{addOnsCount > 1 ? 's' : ''} available</span>
                    </div>
                )}
